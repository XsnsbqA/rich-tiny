(function(e) {
  function t(t) {
    for (
      var n, u, l = t[0], s = t[1], i = t[2], c = 0, p = [];
      c < l.length;
      c++
    )
      (u = l[c]),
  ...
  "56d7": function(e, t, r) {
    ...
    var n = r("2b0e"),
      ...
      d = m,
      _ = (r("a3aa"), Object(u["a"])(d, v, h, !1, null, "84f40e74", null)),
      b = _.exports,
      g = { name: "home", components: { HelloWorld: b } },
      j = g,
      y = Object(u["a"])(j, f, p, !1, null, null, null),
      k = y.exports;
    n["a"].use(c["a"]);
    var w = [
      ...
      O = new c["a"]({ mode: "history", base: "/", routes: w }),
      x = O,
      E = r("2f62");
    n["a"].use(E["a"]);
    var P = new E["a"].Store({
      ...
      $ = function() {
        var e = this,
          t = e.$createElement,
          r = e._self._c || t;
        return r("div", [e._v("I'm a rich text demo.")]);
      },
      C = [],
      S = {},
      T = S,
      H = Object(u["a"])(T, $, C, !1, null, null, null),
      L = H.exports,
      M = {
        install: function(e) {
          e.component("rich-tiny", L);
        }
      },
      W = M;
    n["a"].use(W),
...
//# sourceMappingURL=app.8a46ed5f.js.map
